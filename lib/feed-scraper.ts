...
const SOURCE_SELECTORS: Record<string, string> = {
  'https://www.canada.ca/en/news/advanced-news-search/news-results.html?typ=newsreleases&dprtmnt=revenueagency':
    'article.item a[href]',
  'https://www.ciro.ca/newsroom/news-releases':
    'div.views-field-title a[href]',
  'https://www.ciro.ca/newsroom/publications':
    'div.views-field-title a[href]',
  ...
  'https://fintrac-canafe.canada.ca/pen/4-eng':
    'main a[href]',
  'https://www.osfi-bsif.gc.ca/en/news':
    'a.title--link[href]',
...
export function extractArticleLinks(
  ...
  let anchors = specificSelector
    ...
    : root.querySelectorAll('main a[href], article a[href], [role="main"] a[href]')
